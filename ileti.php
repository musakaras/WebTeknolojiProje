...
<br><br>
    <header>       
        <br><br><br>
        <h1>İletişim Formundan Gelen Bilgiler</h1>
    ...
    <main class="justify">
        ...
        <div class="container mt-5 w-50 text-center p-5">
            ...
            <?php     
                ...
                echo($_POST["surname"]); echo ("\n");  
                echo($_POST["email"]); echo ("\n");  
                echo($_POST["baslik"]); echo ("\n");  
                echo($_POST["konu"]); echo ("\n");  
...
<footer class="bg-danger text-center text-light">
    ...
    <div class="container p-4">
        ...
        <section class="mb-4">
            <p>
                 Musa Karaş tarafından 2022 yılında Sakarya Üniversitesi Web Teknolojileri dersi kapsamında hazırlanmıştır.
            </p>
        </section>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2022 Copyright:
        <a class="text-white" href="https://www.linkedin.com/in/musa-karas/">Musa Karaş</a>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->
